...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      ...
      #    rescue Tv::Justin::Tails::RecoverableException=> e
      #      puts e.message
      #    end
      #
      class RecoverableException < ::Tv::Justin::Tails::TAILSException
      end
    end
  end
end
  ...
  module Justin #:nodoc:
    module Tails
      class RecoverableException
        set_model_id 'tv.justin.tails#RecoverableException'
        ...
        #   new(params)
        #
        # Construct a new RecoverableException. Params can be passed in 
