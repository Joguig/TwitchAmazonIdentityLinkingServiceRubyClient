...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      ...
      #    rescue Tv::Justin::Tails::DependencyException=> e
      #      puts e.message
      #    end
      #
      class DependencyException < ::Tv::Justin::Tails::UnrecoverableException
      end
    end
  end
end
  ...
  module Justin #:nodoc:
    module Tails
      class DependencyException
        set_model_id 'tv.justin.tails#DependencyException'
        ...
        #   new(params)
        #
        # Construct a new DependencyException. Params can be passed in 
