...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      ...
      #
      # == Examples
      #    require 'tv/justin/tails/unlink_twitch_account_request'
      #    
      #    my_input = Tv::Justin::Tails::UnlinkTwitchAccountRequest.new(:my_param => 'value')
      #
      class UnlinkTwitchAccountRequest < ::Coral::Structure
      end
    end
  end
end
  ...
  module Justin #:nodoc:
    module Tails
      class UnlinkTwitchAccountRequest
        set_model_id 'tv.justin.tails#UnlinkTwitchAccountRequest'
        ...
        #   new(params)
        #
        # Construct a new UnlinkTwitchAccountRequest. Params can be passed in 
