...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      ...
      #
      # == Examples
      #    require 'tv/justin/tails/get_twitch_user_name_request'
      #    
      #    my_input = Tv::Justin::Tails::GetTwitchUserNameRequest.new(:my_param => 'value')
      #
      class GetTwitchUserNameRequest < ::Coral::Structure
      end
    end
  end
end
...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      class GetTwitchUserNameRequest
        set_model_id 'tv.justin.tails#GetTwitchUserNameRequest'
        ...
        #   new(params)
        #
        # Construct a new GetTwitchUserNameRequest. Params can be passed in 
