...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      ...
      #
      # == Examples
      #    require 'tv/justin/tails/link_accounts_response'
      #    
      #    my_input = Tv::Justin::Tails::LinkAccountsResponse.new(:my_param => 'value')
      #
      class LinkAccountsResponse < ::Coral::Structure
      end
    end
  end
end
  ...
  module Justin #:nodoc:
    module Tails
      class LinkAccountsResponse
        set_model_id 'tv.justin.tails#LinkAccountsResponse'
        ...
        #   new(params)
        #
        # Construct a new LinkAccountsResponse. Params can be passed in 
