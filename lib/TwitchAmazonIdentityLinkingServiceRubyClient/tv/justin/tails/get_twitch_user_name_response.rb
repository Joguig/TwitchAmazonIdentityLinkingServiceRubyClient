...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      ...
      #
      # == Examples
      #    require 'tv/justin/tails/get_twitch_user_name_response'
      #    
      #    my_input = Tv::Justin::Tails::GetTwitchUserNameResponse.new(:my_param => 'value')
      #
      class GetTwitchUserNameResponse < ::Coral::Structure
      end
    end
  end
end
...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      class GetTwitchUserNameResponse
        set_model_id 'tv.justin.tails#GetTwitchUserNameResponse'
        ...
        #   new(params)
        #
        # Construct a new GetTwitchUserNameResponse. Params can be passed in 
