...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      ...
      #    rescue Tv::Justin::Tails::InvalidParameterException=> e
      #      puts e.message
      #    end
      #
      class InvalidParameterException < ::Tv::Justin::Tails::UnrecoverableException
      end
    end
  end
end
  ...
  module Justin #:nodoc:
    module Tails
      class InvalidParameterException
        set_model_id 'tv.justin.tails#InvalidParameterException'
        ...
        #   new(params)
        #
        # Construct a new InvalidParameterException. Params can be passed in 
