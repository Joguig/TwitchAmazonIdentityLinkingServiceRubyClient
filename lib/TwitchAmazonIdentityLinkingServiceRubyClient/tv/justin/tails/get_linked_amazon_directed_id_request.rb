...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      ...
      #
      # == Examples
      #    require 'tv/justin/tails/get_linked_amazon_directed_id_request'
      #    
      #    my_input = Tv::Justin::Tails::GetLinkedAmazonDirectedIdRequest.new(:my_param => 'value')
      #
      class GetLinkedAmazonDirectedIdRequest < ::Coral::Structure
      end
    end
  end
end
...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      class GetLinkedAmazonDirectedIdRequest
        set_model_id 'tv.justin.tails#GetLinkedAmazonDirectedIdRequest'
        ...
        #   new(params)
        #
        # Construct a new GetLinkedAmazonDirectedIdRequest. Params can be passed in 
