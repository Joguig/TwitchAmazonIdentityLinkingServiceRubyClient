...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      ...
      #    rescue Tv::Justin::Tails::MultipleAmazonAccountsLinkedException=> e
      #      puts e.message
      #    end
      #
      class MultipleAmazonAccountsLinkedException < ::Tv::Justin::Tails::UnrecoverableException
      end
    end
  end
end
...
module Tv #:nodoc:
  module Justin #:nodoc:
    module Tails
      class MultipleAmazonAccountsLinkedException
        set_model_id 'tv.justin.tails#MultipleAmazonAccountsLinkedException'
        ...
        #   new(params)
        #
        # Construct a new MultipleAmazonAccountsLinkedException. Params can be passed in 
