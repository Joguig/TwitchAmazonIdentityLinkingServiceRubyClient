  ...
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Validate
        ...
        #    rescue Com::Amazon::Coral::Validate::ValidationException=> e
        #      puts e.message
        #    end
        #
        class ValidationException < ::Coral::Exception
        end
      end
    end
  end
    ...
    module Coral #:nodoc:
      module Validate
        class ValidationException
          set_model_id 'com.amazon.coral.validate#ValidationException'
          ...
          #   new(params)
          #
          # Construct a new ValidationException. Params can be passed in 
