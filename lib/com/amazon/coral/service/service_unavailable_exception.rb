  ...
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service
        ...
        #    rescue Com::Amazon::Coral::Service::ServiceUnavailableException=> e
        #      puts e.message
        #    end
        #
        class ServiceUnavailableException < ::Coral::Exception
        end
      end
    end
  end
    ...
    module Coral #:nodoc:
      module Service
        class ServiceUnavailableException
          set_model_id 'com.amazon.coral.service#ServiceUnavailableException'
          ...
          #   new(params)
          #
          # Construct a new ServiceUnavailableException. Params can be passed in 
