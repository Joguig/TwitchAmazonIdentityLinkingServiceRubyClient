  ...
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service
        ...
        #    rescue Com::Amazon::Coral::Service::UnknownOperationException=> e
        #      puts e.message
        #    end
        #
        class UnknownOperationException < ::Coral::Exception
        end
      end
    end
  end
    ...
    module Coral #:nodoc:
      module Service
        class UnknownOperationException
          set_model_id 'com.amazon.coral.service#UnknownOperationException'
          ...
          #   new(params)
          #
          # Construct a new UnknownOperationException. Params can be passed in 
