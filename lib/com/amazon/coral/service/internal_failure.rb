  ...
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service
        ...
        #    rescue Com::Amazon::Coral::Service::InternalFailure=> e
        #      puts e.message
        #    end
        #
        class InternalFailure < ::Coral::Exception
        end
      end
    end
  end
    ...
    module Coral #:nodoc:
      module Service
        class InternalFailure
          set_model_id 'com.amazon.coral.service#InternalFailure'
          ...
          #   new(params)
          #
          # Construct a new InternalFailure. Params can be passed in 
