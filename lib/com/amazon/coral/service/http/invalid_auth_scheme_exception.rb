    ...
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          ...
          #    rescue Com::Amazon::Coral::Service::Http::InvalidAuthSchemeException=> e
          #      puts e.message
          #    end
          #
          class InvalidAuthSchemeException < ::Coral::Exception
          end
        end
      end
    end
...
module Com #:nodoc:
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          class InvalidAuthSchemeException
            set_model_id 'com.amazon.coral.service.http#InvalidAuthSchemeException'
            ...
            #   new(params)
            #
            # Construct a new InvalidAuthSchemeException. Params can be passed in 
