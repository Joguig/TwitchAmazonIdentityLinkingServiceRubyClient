    ...
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          ...
          #    rescue Com::Amazon::Coral::Service::Http::MissingMessageDigestException=> e
          #      puts e.message
          #    end
          #
          class MissingMessageDigestException < ::Coral::Exception
          end
        end
      end
    end
...
module Com #:nodoc:
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          class MissingMessageDigestException
            set_model_id 'com.amazon.coral.service.http#MissingMessageDigestException'
            ...
            #   new(params)
            #
            # Construct a new MissingMessageDigestException. Params can be passed in 
