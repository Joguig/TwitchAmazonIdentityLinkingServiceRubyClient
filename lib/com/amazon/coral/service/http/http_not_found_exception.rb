    ...
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          ...
          #    rescue Com::Amazon::Coral::Service::Http::HttpNotFoundException=> e
          #      puts e.message
          #    end
          #
          class HttpNotFoundException < ::Coral::Exception
          end
        end
      end
    end
      ...
      module Service #:nodoc:
        module Http
          class HttpNotFoundException
            set_model_id 'com.amazon.coral.service.http#HttpNotFoundException'
            ...
            #   new(params)
            #
            # Construct a new HttpNotFoundException. Params can be passed in 
