    ...
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          ...
          #    rescue Com::Amazon::Coral::Service::Http::MissingAuthSchemeParameterException=> e
          #      puts e.message
          #    end
          #
          class MissingAuthSchemeParameterException < ::Coral::Exception
          end
        end
      end
    end
...
module Com #:nodoc:
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          class MissingAuthSchemeParameterException
            set_model_id 'com.amazon.coral.service.http#MissingAuthSchemeParameterException'
            ...
            #   new(params)
            #
            # Construct a new MissingAuthSchemeParameterException. Params can be passed in 
