    ...
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          ...
          #    rescue Com::Amazon::Coral::Service::Http::MissingRequiredHeaderException=> e
          #      puts e.message
          #    end
          #
          class MissingRequiredHeaderException < ::Coral::Exception
          end
        end
      end
    end
      ...
      module Service #:nodoc:
        module Http
          class MissingRequiredHeaderException
            set_model_id 'com.amazon.coral.service.http#MissingRequiredHeaderException'
            ...
            #   new(params)
            #
            # Construct a new MissingRequiredHeaderException. Params can be passed in 
