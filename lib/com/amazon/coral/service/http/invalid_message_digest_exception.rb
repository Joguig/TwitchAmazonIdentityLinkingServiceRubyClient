    ...
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          ...
          #    rescue Com::Amazon::Coral::Service::Http::InvalidMessageDigestException=> e
          #      puts e.message
          #    end
          #
          class InvalidMessageDigestException < ::Coral::Exception
          end
        end
      end
    end
...
module Com #:nodoc:
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          class InvalidMessageDigestException
            set_model_id 'com.amazon.coral.service.http#InvalidMessageDigestException'
            ...
            #   new(params)
            #
            # Construct a new InvalidMessageDigestException. Params can be passed in 
