    ...
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          ...
          #    rescue Com::Amazon::Coral::Service::Http::InvalidAuthSchemeParameterException=> e
          #      puts e.message
          #    end
          #
          class InvalidAuthSchemeParameterException < ::Coral::Exception
          end
        end
      end
    end
...
module Com #:nodoc:
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service #:nodoc:
        module Http
          class InvalidAuthSchemeParameterException
            set_model_id 'com.amazon.coral.service.http#InvalidAuthSchemeParameterException'
            ...
            #   new(params)
            #
            # Construct a new InvalidAuthSchemeParameterException. Params can be passed in 
