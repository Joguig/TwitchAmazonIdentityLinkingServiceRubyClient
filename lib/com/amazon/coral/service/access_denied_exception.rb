  ...
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service
        ...
        #    rescue Com::Amazon::Coral::Service::AccessDeniedException=> e
        #      puts e.message
        #    end
        #
        class AccessDeniedException < ::Coral::Exception
        end
      end
    end
  end
    ...
    module Coral #:nodoc:
      module Service
        class AccessDeniedException
          set_model_id 'com.amazon.coral.service#AccessDeniedException'
          ...
          #   new(params)
          #
          # Construct a new AccessDeniedException. Params can be passed in 
