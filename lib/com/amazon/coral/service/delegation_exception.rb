  ...
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service
        ...
        #    rescue Com::Amazon::Coral::Service::DelegationException=> e
        #      puts e.message
        #    end
        #
        class DelegationException < ::Coral::Exception
        end
      end
    end
  end
    ...
    module Coral #:nodoc:
      module Service
        class DelegationException
          set_model_id 'com.amazon.coral.service#DelegationException'
          ...
          #   new(params)
          #
          # Construct a new DelegationException. Params can be passed in 
