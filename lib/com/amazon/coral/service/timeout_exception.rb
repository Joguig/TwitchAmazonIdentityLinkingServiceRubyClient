  ...
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service
        ...
        #    rescue Com::Amazon::Coral::Service::TimeoutException=> e
        #      puts e.message
        #    end
        #
        class TimeoutException < ::Coral::Exception
        end
      end
    end
  end
    ...
    module Coral #:nodoc:
      module Service
        class TimeoutException
          set_model_id 'com.amazon.coral.service#TimeoutException'
          ...
          #   new(params)
          #
          # Construct a new TimeoutException. Params can be passed in 
