  ...
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service
        ...
        #    rescue Com::Amazon::Coral::Service::MalformedHttpRequestException=> e
        #      puts e.message
        #    end
        #
        class MalformedHttpRequestException < ::Coral::Exception
        end
      end
    end
  end
...
module Com #:nodoc:
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service
        class MalformedHttpRequestException
          set_model_id 'com.amazon.coral.service#MalformedHttpRequestException'
          ...
          #   new(params)
          #
          # Construct a new MalformedHttpRequestException. Params can be passed in 
