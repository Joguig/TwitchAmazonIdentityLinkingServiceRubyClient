  ...
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Service
        ...
        #    rescue Com::Amazon::Coral::Service::NotAuthorizedException=> e
        #      puts e.message
        #    end
        #
        class NotAuthorizedException < ::Coral::Exception
        end
      end
    end
  end
    ...
    module Coral #:nodoc:
      module Service
        class NotAuthorizedException
          set_model_id 'com.amazon.coral.service#NotAuthorizedException'
          ...
          #   new(params)
          #
          # Construct a new NotAuthorizedException. Params can be passed in 
