  ...
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Availability
        ...
        #    rescue Com::Amazon::Coral::Availability::BackOffException=> e
        #      puts e.message
        #    end
        #
        class BackOffException < ::Coral::Exception
        end
      end
    end
  end
    ...
    module Coral #:nodoc:
      module Availability
        class BackOffException
          set_model_id 'com.amazon.coral.availability#BackOffException'
          ...
          #   new(params)
          #
          # Construct a new BackOffException. Params can be passed in 
