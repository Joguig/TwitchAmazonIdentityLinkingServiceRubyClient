  ...
  module Amazon #:nodoc:
    module Coral #:nodoc:
      module Availability
        ...
        #    rescue Com::Amazon::Coral::Availability::ThrottlingException=> e
        #      puts e.message
        #    end
        #
        class ThrottlingException < ::Coral::Exception
        end
      end
    end
  end
    ...
    module Coral #:nodoc:
      module Availability
        class ThrottlingException
          set_model_id 'com.amazon.coral.availability#ThrottlingException'
          ...
          #   new(params)
          #
          # Construct a new ThrottlingException. Params can be passed in 
